...
import { Copy, Download, Type, RotateCcw, ArrowDown } from 'lucide-react'
...
export default function TextToLowercase() {
  const [inputText, setInputText] = useState('')
  const [result, setResult] = useState<ConversionResult | null>(null)
  const [loading, setLoading] = useState(false)
  const [error, setError] = useState<string | null>(null)
  
  const { trackUsage } = useToolAccess('text-to-lowercase')
  ...
  const downloadResult = () => {
    if (result) {
      const content = `Text to Lowercase Conversion
...
- Special Characters: ${result.statistics.special}`
      ...
      a.href = url
      a.download = 'lowercase-conversion.txt'
  ...
  const loadSample = () => {
    setInputText('Hello World! This is a SAMPLE text for testing the lowercase converter.')
    setResult(null)
    setError(null)
  }
  ...
  return (
    <ToolLayout
      toolId="text-to-lowercase"
      toolName="Text to Lowercase"
      toolDescription="Convert text to lowercase letters instantly"
      toolCategory="Text Tools"
      toolIcon={<ArrowDown className="w-8 h-8" />}
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the text you want to convert to lowercase
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Lowercase Result</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            {loading ? (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-muted-foreground">Converting to lowercase...</p>
              </div>
            ) : result ? (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  ...
                  <div className="text-center p-3 bg-orange-50 border border-orange-200 rounded-lg">
                    <div className="text-2xl font-bold text-orange-900">{result.statistics.lowercase}</div>
                    <div className="text-sm text-orange-700">Lowercase</div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <Badge variant="outline">{result.statistics.uppercase}</Badge>
                    </div>
                    <div className="flex justify-between">
                      <span>Numbers:</span>
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <ArrowDown className="w-12 h-12 text-muted-foreground mb-4" />
                <h3 className="text-lg font-medium mb-2">Ready to convert</h3>
                <p className="text-muted-foreground">
                  Enter text above and click "Convert to Lowercase" to transform it
                </p>
              </div>
            )}
          </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-sm font-medium">Lowercase Conversion Information</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>• Converts all uppercase letters to lowercase</li>
                <li>• Leaves numbers and symbols unchanged</li>
                <li>• Preserves existing lowercase letters</li>
            ...
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>• Creating consistent text formatting</li>
                <li>• Standardizing text for display</li>
                <li>• Preparing text for processing</li>
