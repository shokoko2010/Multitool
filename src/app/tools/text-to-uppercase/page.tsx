...
import { Copy, Download, Type, RotateCcw, ArrowUp } from 'lucide-react'
...
export default function TextToUppercase() {
  const [inputText, setInputText] = useState('')
  const [result, setResult] = useState<ConversionResult | null>(null)
  const [loading, setLoading] = useState(false)
  const [error, setError] = useState<string | null>(null)
  
  const { trackUsage } = useToolAccess('text-to-uppercase')
  ...
  const downloadResult = () => {
    if (result) {
      const content = `Text to Uppercase Conversion
...
- Special Characters: ${result.statistics.special}`
      ...
      a.href = url
      a.download = 'uppercase-conversion.txt'
  ...
  const loadSample = () => {
    setInputText('Hello World! This is a SAMPLE text for testing the uppercase converter.')
    setResult(null)
    setError(null)
  }
  ...
  return (
    <ToolLayout
      toolId="text-to-uppercase"
      toolName="Text to Uppercase"
      toolDescription="Convert text to uppercase letters instantly"
      toolCategory="Text Tools"
      toolIcon={<ArrowUp className="w-8 h-8" />}
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the text you want to convert to uppercase
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Uppercase Result</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            {loading ? (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-muted-foreground">Converting to uppercase...</p>
              </div>
            ) : result ? (
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-lg font-mono font-semibold text-blue-900 leading-relaxed">
                      {result.convertedText}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  <div className="text-center p-3 bg-green-50 border border-green-200 rounded-lg">
                    <div className="text-2xl font-bold text-green-900">{result.characterCount}</div>
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                <ArrowUp className="w-12 h-12 text-muted-foreground mb-4" />
                <h3 className="text-lg font-medium mb-2">Ready to convert</h3>
                <p className="text-muted-foreground">
                  Enter text above and click "Convert to Uppercase" to transform it
                </p>
              </div>
            )}
          </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-sm font-medium">Uppercase Conversion Information</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>• Converts all lowercase letters to uppercase</li>
                <li>• Leaves numbers and symbols unchanged</li>
                <li>• Preserves existing uppercase letters</li>
            ...
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>• Creating headings and titles</li>
                <li>• Emphasizing important text</li>
                <li>• Standardizing text formatting</li>
                <li>• Programming constants</li>
